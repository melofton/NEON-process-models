...
parms <- read.csv("./Models/procHinshelwoodSteeleParameters.csv")
parms[j,c(2:9)] <- c(fit2$par,rmse(par = fit2$par, chla, wtemp, swr))
write.csv(parms, "./Models/procHinshelwoodSteeleParameters.csv", row.names = FALSE)
