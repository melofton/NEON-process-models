...
message('starting procEppleyNorbergMonod forecast generations')
...
parms <- read_csv("./Models/procEppleyNorbergMonodParameters.csv")
...
procEppleyNorbergMonod_EFI <- convert.to.efi_standard(forecast)
  

forecast_file <- paste0('aquatics-', procEppleyNorbergMonod_EFI$reference_datetime[1], '-', team_name, '.csv.gz')

write_csv(procEppleyNorbergMonod_EFI, forecast_file)
# Submit forecast!
