...
team_name <- "procHinshelwoodSteele"
...
message('starting procHinshelwoodSteele forecast generations')
...
parms <- read_csv("./Models/procHinshelwoodSteeleParameters.csv")
...
procHinshelwoodSteele_EFI <- convert.to.efi_standard(forecast)
  

forecast_file <- paste0('aquatics-', procHinshelwoodSteele_EFI$reference_datetime[1], '-', team_name, '.csv.gz')

write_csv(procHinshelwoodSteele_EFI, forecast_file)
# Submit forecast!
